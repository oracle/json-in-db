...
function renderSampleDocuments() {
  ...
  jPP.printJson(document.getElementById("sampleTheater"),null,theater);
  jPP.printJson(document.getElementById("sampleMovie"),null,movie);
  jPP.printJson(document.getElementById("sampleScreening"),null,screening);
